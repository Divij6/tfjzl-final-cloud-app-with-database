...
class Question(models.Model):
    ...
    # Calculates whether the learner gets full score for this question
...
class Choice(models.Model):
    ...
    def __str__(self):
        return self.content + " | Correct: " + str(self.is_correct)


# Submission model
# One enrollment can have multiple submissions
# One submission can have multiple choices (Many-to-Many)
